...
namespace MVCEventApplication.Models
{
    public class SampleData : DropCreateDatabaseIfModelChanges<MVCEventDB>
    {
        protected override void Seed(MVCEventDB context)
        {
            var eventtypes = new List<EventType>
            {
                ...
                new EventType { TypeName = "Volunteer"},
                new EventType { TypeName = "Workshop"},
                new EventType { TypeName = "Auction"},
                new EventType { TypeName = "Sale"},

                new EventType { TypeName = "Networking"},
                new EventType { TypeName = "Convention"},
                new EventType { TypeName = "Film"},
                new EventType { TypeName = "Food"},
                new EventType { TypeName = "Religious"},
            };
                    ...
                    new List<Event>
            {
                //Concerts
                    new Event { Title = "Wheel Big Phish", Description = "Ska classic Wheel Big Phish is at the Pog Shop",
                        ...
                        Location = "Cleveland", EventType = eventtypes.Single(e => e.TypeName == "Concert"), OrganizerName = "Pog Shop",
                ...
                //Volunteer
                    ...
                    new Event { Title = "Soup kitchen", Description = "Help feed the homeless",
                        ...
                        Location = "Hudson", EventType = eventtypes.Single(e => e.TypeName == "Volunteer"), OrganizerName = "Souper Man",
                 ...
                 //Workshop
                    ...
                    new Event { Title = "How to make friends in your 30s", Description = "Learn how to make friends as you age",
                        ...
                        Location = "Highland", EventType = eventtypes.Single(e => e.TypeName == "Workshop"), OrganizerName = "Tri-C",
                    ...
                    new Event { Title = "Find your voice", Description = "Learn how to become a voice actor",
                        StartDate =DateTime.ParseExact("03-24-2021","MM-dd-yyyy",null),
                        StartTime = "6:00PM", EndDate=DateTime.ParseExact("03-01-2020","MM-dd-yyyy",null), EndTime = "9:00PM",
                        Location = "Highland", EventType = eventtypes.Single(e => e.TypeName == "Workshop"), OrganizerName = "Tri-C",
                 ...
                 //Auction
                    ...
                    new Event { Title = "Auction Hunters", Description = "Become an auctioneer",
                        StartDate =DateTime.ParseExact("06-10-2020","MM-dd-yyyy",null),
                        StartTime = "6:00PM", EndDate=DateTime.ParseExact("06-11-2020","MM-dd-yyyy",null), EndTime = "7:00PM",
                        Location = "Solon", EventType = eventtypes.Single(e => e.TypeName == "Auction"), OrganizerName = "Saleby's",
                    ...
                    new Event { Title = "Military surplus Auction", Description = "Win some old rations",
                        StartDate =DateTime.ParseExact("07-18-2020","MM-dd-yyyy",null),
                        StartTime = "6:00PM", EndDate=DateTime.ParseExact("07-20-2020","MM-dd-yyyy",null), EndTime = "9:00PM",
                        Location = "Solon", EventType = eventtypes.Single(e => e.TypeName == "Auction"), OrganizerName = "Saleby's",
                ...
                //Sale
                    ...
                    new Event { Title = "Amazon surplus sale", Description = "Buy refunded amazon items",
                        StartDate =DateTime.ParseExact("06-10-2020","MM-dd-yyyy",null),
                        StartTime = "6:00PM", EndDate=DateTime.ParseExact("06-11-2020","MM-dd-yyyy",null), EndTime = "7:00PM",
                        Location = "Solon", EventType = eventtypes.Single(e => e.TypeName == "Sale"), OrganizerName = "Saleby's",
                  ...
                  //Networking
                    ...
                    new Event { Title = "Programming networking event", Description = "Python networking",
                        ...
                        Location = "Twinsburg", EventType = eventtypes.Single(e => e.TypeName == "Convention"), OrganizerName = "Meet's",
                 ...
                 //Convention
                    ...
                    new Event { Title = "Colossal con", Description = "Anime Convetion",
                ...
                //Film
                    ...
                    new Event { Title = "DC Hero Movie", Description = "Man bat and the Jokester",
                        ...
                        Location = "Akron", EventType = eventtypes.Single(e => e.TypeName == "Film"), OrganizerName = "ABC",
                  ...
                  //Food
                    ...
                    new Event { Title = "Indian Food", Description = "",
                        ...
                        Location = "Aurora", EventType = eventtypes.Single(e => e.TypeName == "Film"), OrganizerName = "Indian Restaurant",
                    ...
                    new Event { Title = "Thai Food", Description = "",
                        ...
                        Location = "Aurora", EventType = eventtypes.Single(e => e.TypeName == "Film"), OrganizerName = "Thai Restaurant",
                    ...
                    new Event { Title = "Chinese Food", Description = "",
                        StartDate =DateTime.ParseExact("05-20-2020","MM-dd-yyyy",null),
                        StartTime = "1:00PM", EndDate=DateTime.ParseExact("05-20-2020","MM-dd-yyyy",null), EndTime = "8:00PM",
                        Location = "Aurora", EventType = eventtypes.Single(e => e.TypeName == "Film"), OrganizerName = "Chinese Restaurant",
                        Number = "330-888-8873", MaxTickets = 35, TicketsAvailable = 35},
              ...
              //Religious
                    ...
                    new Event { Title = "Religious Event 1" , Description = "Nondescript",
                        ...
                        Location = "Bedford", EventType = eventtypes.Single(e => e.TypeName == "Religious"), OrganizerName = "Nondescript church",
