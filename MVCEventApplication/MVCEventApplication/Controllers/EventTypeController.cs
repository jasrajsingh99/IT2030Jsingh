...
using MVCEventApplication.Models;

namespace MVCEventApplication.Controllers
{
    public class EventTypeController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventTypeId,TypeName")] EventType eventType)
        {
            if (ModelState.IsValid)
            {
